...
import ConfirmmationModal from "../../../common/ConfirmationModal";
...
const CoursesTable = ({ courses, setCourses }) => {
  ...
  return (
    <>
                    ...
                    <button
                      ...
                      onClick={() => {
                        setConfirmationModal({
                          ...
                          text2:
                            "All the data related to the course will be deleted",
                          btn1Text: "Delete",
                          btn2Text: "Cancel",
                          btn1Handler: !loading
      ...
      {confirmationModal && (
        <ConfirmmationModal modalData={confirmationModal} />
      )}
    </>
  );
};
